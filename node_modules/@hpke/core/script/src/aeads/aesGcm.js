(function (factory) {
    ...
    class AesGcmContext extends common_1.NativeAlgorithm {
        constructor(key) {
            ...
            this._rawKey = (0, common_1.toArrayBuffer)(key);
        }
        async seal(iv, data, aad) {
            await this._setupKey();
            const alg = {
                name: "AES-GCM",
                iv: (0, common_1.toArrayBuffer)(iv),
                additionalData: (0, common_1.toArrayBuffer)(aad),
            };
            const ct = await this._api.encrypt(alg, this._key, (0, common_1.toArrayBuffer)(data));
            return ct;
        }
        async open(iv, data, aad) {
            ...
            const pt = await this._api.decrypt(alg, this._key, (0, common_1.toArrayBuffer)(data));
            return pt;
        }
        async _setupKey() {
