(function (factory) {
    ...
    class X448 extends common_1.NativeAlgorithm {
        ...
        async deserializePublicKey(key) {
            await this._setup();
            try {
                return await this._importRawKey((0, common_1.toArrayBuffer)(key), true);
            }
            catch (e) {
        ...
        async deserializePrivateKey(key) {
            await this._setup();
            try {
                return await this._importRawKey((0, common_1.toArrayBuffer)(key), false);
            }
            catch (e) {
                throw new common_1.DeserializeError(e);
            }
        ...
        async deriveKeyPair(ikm) {
            await this._setup();
            try {
                const rawIkm = (0, common_1.toArrayBuffer)(ikm);
                const dkpPrk = await this._hkdf.labeledExtract(common_1.EMPTY, common_1.LABEL_DKP_PRK, new Uint8Array(rawIkm));
