    ...
    class CipherSuiteNative extends common_1.NativeAlgorithm {
        ...
        async _keySchedule(mode, sharedSecret, params) {
            ...
            const pskId = params.psk === undefined
                ? common_1.EMPTY
                : (0, common_1.toUint8Array)(params.psk.id);
            const pskIdHash = await this._kdf.labeledExtract(common_1.EMPTY, LABEL_PSK_ID_HASH, pskId);
            const info = params.info === undefined ? common_1.EMPTY : (0, common_1.toUint8Array)(params.info);
            ...
            const psk = params.psk === undefined ? common_1.EMPTY : (0, common_1.toUint8Array)(params.psk.key);
