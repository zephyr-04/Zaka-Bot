(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../consts.js", "../errors.js", "../interfaces/kemInterface.js", "../kdfs/hkdf.js", "../utils/misc.js"], factory);
    }
    ...
    class Dhkem {
        ...
        async deserializePublicKey(key) {
            return await this._prim.deserializePublicKey((0, hkdf_js_1.toArrayBuffer)(key));
        }
        async serializePrivateKey(key) {
            return await this._prim.serializePrivateKey(key);
        }
        async deserializePrivateKey(key) {
            return await this._prim.deserializePrivateKey((0, hkdf_js_1.toArrayBuffer)(key));
        }
        ...
        async deriveKeyPair(ikm) {
            ...
            if (rawIkm.byteLength > consts_js_1.INPUT_LENGTH_LIMIT) {
