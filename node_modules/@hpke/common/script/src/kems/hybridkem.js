(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../consts.js", "../errors.js", "../kdfs/hkdf.js", "../identifiers.js", "../interfaces/dhkemPrimitives.js", "../interfaces/kemInterface.js", "../utils/misc.js", "../xCryptoKey.js"], factory);
    }
    ...
    class Hybridkem {
        ...
        async deserializePublicKey(key) {
            try {
                return await this._deserializePublicKey((0, hkdf_js_1.toArrayBuffer)(key));
            }
            catch (e) {
        ...
        async deserializePrivateKey(key) {
            try {
                return await this._deserializePrivateKey((0, hkdf_js_1.toArrayBuffer)(key));
            }
            catch (e) {
                throw new errors_js_1.DeserializeError(e);
            }
        ...
        async deriveKeyPair(ikm) {
            ...
            const dkpPrk = await this._kdf.labeledExtract(consts_js_1.EMPTY.buffer, dhkemPrimitives_js_1.LABEL_DKP_PRK, new Uint8Array(rawIkm));
        ...
        async encap(params) {
            ...
            if (params.ekm !== undefined && !(0, misc_js_1.isCryptoKeyPair)(params.ekm)) {
                const ekm = (0, hkdf_js_1.toArrayBuffer)(params.ekm);
        ...
        async decap(params) {
            const enc = (0, hkdf_js_1.toArrayBuffer)(params.enc);
