import type { LinkedAccount, LinkedAccountEmbeddedWallet } from "../resources/users.js";
 ...
 */
export declare const isEmbeddedWalletLinkedAccount: (account: LinkedAccount) => account is LinkedAccountEmbeddedWallet;
