import { SolanaSignAndSendTransactionRpcResponse, SolanaSignMessageRpcResponse, SolanaSignTransactionRpcResponse, WalletRpcParams } from "../../resources.mjs";
...
export declare class PrivySolanaService {
    ...
    signMessage(walletId: string, { message, ...input }: PrivySolanaService.SignMessageInput): Promise<SolanaSignMessageRpcResponse.Data>;
    signTransaction(walletId: string, { transaction, ...input }: PrivySolanaService.SignTransactionInput): Promise<SolanaSignTransactionRpcResponse.Data>;
    signAndSendTransaction(walletId: string, { transaction, ...input }: PrivySolanaService.SignAndSendTransactionInput): Promise<SolanaSignAndSendTransactionRpcResponse.Data>;
}
/**
